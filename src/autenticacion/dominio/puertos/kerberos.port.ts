...
export interface KerberosPort {
  intercambioCodigo(code: string): Promise<string>;
  ...
  obtenerUsuariosSistema(idSistema: string, accessToken: string, busqueda?: string): Promise<{ data: KerberosUsuarioSistema[]; meta: KerberosPaginacion }>;
}
