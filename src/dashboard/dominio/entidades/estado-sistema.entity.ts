...
export class EstadoSistema {
  ...
  constructor(procesos: EstadoProcesoPM2[], baseDatos: EstadoBaseDatos, hardware: RecursosHardware, websocket: EstadoWebSocket, serviciosExternos: EstadoServicioExterno[]) {
